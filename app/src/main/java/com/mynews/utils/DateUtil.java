...
public class DateUtil {
	...
	private final static SimpleDateFormat sdfDaysTimes = new SimpleDateFormat("yyyyMMddHH");
	 ...
	 * @return
	 */
	public static String getDaysTimes() {
		return sdfDaysTimes.format(new Date());
	}
